...
> **Agent4ML note:** The original deer-flow skill uses AI image-generation per
  slide. Agent4ML may not have image-generation available. This version generates
...
# Save
prs.save('.agent4ml/outputs/presentation.pptx')
print('Saved to .agent4ml/outputs/presentation.pptx')
"
```
...
```
present_files([".agent4ml/outputs/presentation.pptx"])
```
