...
> **Agent4ML note:** The original deer-flow skill uses a bundled
> `scripts/generate.js` (Node.js + charting library). Agent4ML doesn't bundle
...
plt.tight_layout()
plt.savefig('.agent4ml/outputs/chart.png', dpi=150, bbox_inches='tight')
print('Saved to .agent4ml/outputs/chart.png')
"
```
...
plt.savefig('.agent4ml/outputs/bar.png', dpi=150)
"
...
plt.savefig('.agent4ml/outputs/scatter.png', dpi=150)
"
...
plt.savefig('.agent4ml/outputs/pie.png', dpi=150)
"
```
