...
Use Agent4ML tools for the research step:
...
> **Agent4ML note:** The original skill runs comparison spikes (002a / 002b) in
> parallel via subagent delegation. Agent4ML has no subagents, so build
